...
function ShopAll({ productsData }) {
    ...
    const trayData = { image: "https://flameprodev.cda-development3.co.uk/cms/wp-content/uploads/2024/02/Firefighting-bannerimage.jpg", title: 'Shop', speak_to_us_button: 'Speak To Us' }
