...
import styles from './teamBlockContactForm.module.css';

function TeamBlockContactForm({ heading, formFields, heading2, isFromPopup }) {
    ...
    const checkBoxText = 'Subscribe to newsletter';
                            ...
                            <section className={styles.formInput}>
                                {fieldName?.section2 !== "Area Of Interest*" ? (
                                    <input
                                        ...
                                        className={
                                            fieldName?.section2 === "Area Of Interest*"
                                                ? styles.areaInterestInput : fieldName?.section2 === 'Phone Number*' ? styles.textInputPhoneNum
                                                    : styles.textInput
                                        }
                                ...
                                {fieldName.section2 === 'Phone Number*' && <CountrySelector />}
...
export default TeamBlockContactForm