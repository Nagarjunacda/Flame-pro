...
function FourCategoryCard({ data, blockTitle, isFromResourceHub }) {
  ...
  return (
    <Card className={styles.cardCont}>
      <Card.Img variant="top" src={cardImage} className={isFromResourceHub ? styles.resourceHubCardImg : styles.cardImg} />
