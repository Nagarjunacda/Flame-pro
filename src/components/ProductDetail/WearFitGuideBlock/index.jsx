    ...
    return <section className={styles.mainCont}>
        ...
        <section className={styles.downloadsBlock}>
            ...
            <section className={styles.brochure}>
                {downloads && downloads.map((e) => {
                    return <section className={styles.brochureItem}>
                        <a href={e?.wearfit_file?.link} download={e?.wearfit_file?.filename} target="blank">
                            <FlameImage src={downloadIconSrc} alt={"downloadIcon"} />
                        </a>
                        <a href={e?.wearfit_file?.link} download={e?.wearfit_file?.filename} target="blank">
                            <h5 className={styles.brochureText}>{e?.wearfit_button_title}</h5>
                        </a>
                    </section>
                })}
            </section>
